...
extern string PATH_FULL_ALIF;
extern string PATH_FULL_BIN;
extern string PATH_FULL_LOG;
extern string PATH_WORKING;
extern bool DEBUG;
extern bool ERROR_PRINT_ON_SCREEN;
extern bool THIS_IS_ALIF_C_FILE;
extern string PATH_FULL_CPP;
extern string PATH_FULL_ICO;
...
void ALIF_HELP() {
  ...
  cout << "--------------------------------------------" << endl << endl;
  cout << " Usage:  alif  [source.alif] [output.exe]  [logfile.txt]  "
          "[Options...]"
       << endl
  ...
  cout << "(C)2020 DRAGA Hassan - www.aliflang.org" << endl;
  cout << "------------------------------------------" << endl << endl;
  cout << " Usage:  alif  [source.alif]  [output.app]  [logfile.txt]  "
          "[Options...]"
       << endl
       << endl;
  cout << " Options : " << endl << endl << Options << endl << endl;
  // cout << "   iPhone Application Usage:  alif [source.alifi] [output.app]
  // [logfile]" << endl; cout << " " << endl; cout << "   Windows Application
  // Usage:  Unsuported. (You need Alif Compiler Windows Version)" << endl; cout
  // << "   Linux Application Usage:  Unsuported. (You need Alif Compiler Linux
  // Version)" << endl; cout << "   Android Application Usage:  Unsuported. (You
  // need Alif Compiler Windows Version)" << endl;

#else

  cout << "Alif Compiler " << VERSION << " - GNU Linux (GTK2_x86_64)"
       << endl; // x86_64
  cout << "(C)2020 DRAGA Hassan - www.aliflang.org" << endl;
  cout << "------------------------------------------" << endl << endl;
  cout << " Usage:  alif  [source.alif]  [output.bin]  [logfile.txt]  "
          "[Options...]"
       << endl
       << endl;
  cout << " Options : " << endl << endl << Options << endl << endl;
  // cout << "   Linux 32 Application Usage:  alif [source.alif] [output]
  // [logfile] -32" << endl; cout << " " << endl; cout << "   Windows
  // Application Usage:  Unsuported. (You need Alif Compiler Windows Version)"
  // << endl; cout
  // << "   Mac OS X Application Usage:  Unsuported. (You need Alif Compiler Mac
  // OS X Version)" << endl; cout << "   Android Application Usage:  Unsuported.
  // (You need Alif Compiler Windows Version)" << endl; cout << "   iPhone
  // Application Usage:  Unsuported. (You need Alif Compiler Mac OS X Version)"
  // << endl;
...
#endif
{
  ...
  string CLEAR_BIN_CMD =
      string("rm -rf \"") + PATH_FULL_BIN + string("\" 2> /dev/null");
