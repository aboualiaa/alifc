...
void parser_FunctionClass(std::string Token[2048], lex::Token *o_tokens) {
  // Class -> دالة
      ...
      if (Token[FUN_POS + 1] == "عدد") {
        if (Token[1] == "خاص") {
          if (!o_tokens->TOKENS_PREDEFINED) {
            ...
            CPP_CLASS.append(" private: double ClassFUNCTION_" +
                             ID[Token[FUN_POS + 2]] + "() { \n");
            // *** *** *** *** *** ***
          }
        } else {
          if (!o_tokens->TOKENS_PREDEFINED) {
            ...
            // *** Generate Code ***
            // Class -> INT-Func
            CPP_CLASS.append(" public: double ClassFUNCTION_" +
                             ID[Token[FUN_POS + 2]] + "() { \n");
            // *** *** *** *** *** ***
          }
        }
        ...
        if (Token[1] == "خاص") {
          if (!o_tokens->TOKENS_PREDEFINED) {
            ...
            CPP_CLASS.append(" private: wxString ClassFUNCTION_" +
                             ID[Token[FUN_POS + 2]] + "() { \n");
            // *** *** *** *** *** ***
          }
        } else {
          if (!o_tokens->TOKENS_PREDEFINED) {
            ...
            // *** Generate Code ***
            // Class -> STRING-Func
            CPP_CLASS.append(" public: wxString ClassFUNCTION_" +
                             ID[Token[FUN_POS + 2]] + "() { \n");
            // *** *** *** *** *** ***
          }
        }
        ...
        if (Token[1] == "خاص") {
          if (!o_tokens->TOKENS_PREDEFINED) {
            ...
            CPP_CLASS.append(" private: bool ClassFUNCTION_" +
                             ID[Token[FUN_POS + 2]] + "() { \n");
            // *** *** *** *** *** ***
          }
        } else {
          if (!o_tokens->TOKENS_PREDEFINED) {
            ...
            // *** Generate Code ***
            // Class -> BOOL-Func
            CPP_CLASS.append(" public: bool ClassFUNCTION_" +
                             ID[Token[FUN_POS + 2]] + "() { \n");
            // *** *** *** *** *** ***
          }
        }
    ...
    if (Token[FUN_POS + 2].empty()) // دالة MyFunctionName
    {
      if (Token[1] == "خاص") {
        if (!o_tokens->TOKENS_PREDEFINED) {
          ...
          // *** Generate Code ***
          // Class -> Private Func
          CPP_CLASS.append(" private: void ClassFUNCTION_" +
                           ID[Token[FUN_POS + 1]] + "() { \n");
          // *** *** *** *** *** ***
        }
      } else {
        if (!o_tokens->TOKENS_PREDEFINED) {
          ...
          // *** Generate Code ***
          // Class -> Func
          CPP_CLASS.append(" public: void ClassFUNCTION_" +
                           ID[Token[FUN_POS + 1]] + "() { \n");
          // *** *** *** *** *** ***
        }
      }
