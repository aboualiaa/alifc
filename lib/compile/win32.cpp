...
void CLEAN() {
  ...
  if (!THIS_IS_ALIF_C_FILE) {
    ...
    CLEAR_CMD = string("del \"" + PATH_TEMP + "\\alifcompiler_" + RANDOM +
                       "_strip.bat\" ");
...
void COMPILE_WIN_32BIT() // string RAND)
{
  ...
  // "%CURRENT_PATH%\Bin\Win_32\installer\bin\g++" -finput-charset=utf-8 -c -o
  // "%CURRENT_PATH%\Bin\Win_32\win_alifstudio.o" -O2 -mthreads -DHAVE_W32API_H
  // -D__WXMSW__ -DwxDEBUG_LEVEL=0 -DNDEBUG -I. -I
  // "%CURRENT_PATH%\Bin\Win_32\installer\include" -W
  // -Wno-deprecated-declarations -DNOPCH -Wno-ctor-dtor-privacy -Os -s
  // -fno-keep-inline-dllexport -std=gnu++11 -m32
  // -MT"%CURRENT_PATH%\Bin\Win_32\win_alifstudio.o"
  // -MF"%CURRENT_PATH%\Bin\Win_32\win_alifstudio.o.d" -MD -MP
  // "Src\alifstudio.cpp"
  ...
  CMD = "@echo off\n"
        ...
        PATH_ABSOLUTE +
        "\\include\""
        " -W -Wno-deprecated-declarations -DNOPCH -Wno-ctor-dtor-privacy -Os "
        "-s -fno-keep-inline-dllexport"
        " -std=gnu++11 -m32 \"" +
        PATH_FULL_CPP + "\" 2> \"" + PATH_TEMP + "\\alifcompiler_" + RANDOM +
        "_compile.log\"";
  ...
  if (!LOG_LINE8_Buffer.empty()) {
    ...
    ALIF_ERROR("Please report this error to the Alif Community : "
               "www.aliflang.org/community \n\nAlif Compiler " +
               VERSION + " - TDM-GCC (32Bit) C++11\n\nFile : " +
  ...
  // if (!THIS_IS_ALIF_C_FILE)
  //{
  // "%CURRENT_PATH%\Bin\Win_32\installer\bin\windres.exe" -I
  // "%CURRENT_PATH%\Bin\Win_32\installer\include" -J rc -O coff -i
  // "%CURRENT_PATH%\Res\win_alifstudio.rc" -o
  // "%CURRENT_PATH%\Bin\Win_32\win_alifstudio.res" --define __WXMSW__ --define
  // wxDEBUG_LEVEL=0
  ...
  CMD = "@echo off\n"
        ...
        ".res\""
        " --define __WXMSW__ --define wxDEBUG_LEVEL=0 --define NDEBUG --define "
        "_UNICODE --define NOPCH 2> \"" +
        PATH_TEMP + "\\alifcompiler_" + RANDOM + "_resource.log\"";
  ...
  // -o "%CURRENT_PATH%\Bin\Win_32\alifstudio.exe"
  // "%CURRENT_PATH%\Bin\Win_32\win_alifstudio.res"
  // "%CURRENT_PATH%\Bin\Win_32\win_alifstudio.o" -mthreads
  // -L"%CURRENT_PATH%\Bin\Win_32\installer\lib" -Wl,--subsystem,windows
  // -mwindows -lwxmsw31u_alif_lib_gl -lopengl32 -lglu32 -lwxmsw31u_alif_lib_aui
  // -lwxmsw31u_alif_lib_propgrid -lwxmsw31u_alif_lib_adv
  // -lwxmsw31u_alif_lib_stc -lwxmsw31u_alif_lib_core  -lwxbase31u_alif_lib
  // -lwxscintilla -lwxtiff -lwxjpeg -lwxpng -lwxzlib -lwxregexu -lwxexpat
  // -lkernel32 -luser32 -lgdi32 -lcomdlg32 -lwinspool -lwinmm -lshell32
  // -lshlwapi -lcomctl32 -lole32 -loleaut32 -luuid -lrpcrt4 -ladvapi32
  // -lversion -lwsock32 -lwininet -loleacc -luxtheme
  ...
  CMD =
      ...
      PATH_ABSOLUTE +
      "\\lib\" "
      " -lwxmsw31u_alif_lib_gl -lopengl32 -lglu32 -lwxmsw31u_alif_lib_webview "
      "-lwxmsw31u_alif_lib_aui -lwxmsw31u_alif_lib_propgrid"
      " -lwxmsw31u_alif_lib_adv -lwxmsw31u_alif_lib_stc "
      "-lwxmsw31u_alif_lib_core  -lwxbase31u_alif_lib"
      " -lwxscintilla -lwxtiff -lwxjpeg -lwxpng -lwxzlib -lwxregexu -lwxexpat "
      "-lkernel32 -luser32 -lgdi32"
      " -lcomdlg32 -lwinspool -lwinmm -lshell32 -lshlwapi -lcomctl32 -lole32 "
      "-loleaut32 -luuid -lrpcrt4"
      " -ladvapi32 -lversion -lwsock32 -lwininet -loleacc " +
  ...
  if (!THIS_IS_ALIF_C_FILE) {
    // "%ALIF_CURRENT_PATH%\Win\_alif\bin\strip" --strip-all
    // "Win\alifstudio.exe"
