...
static const string ALIF_RESERVED[] = {
...
static std::map<std::pair<string, int>, string>
...
static std::map<std::pair<string, string>, bool>
    CLASS_FUN_IS_SET; // abc[class][fun] = class fun already set ?
static std::map<std::pair<string, string>, string>
...
static std::map<std::pair<string, string>, int>
