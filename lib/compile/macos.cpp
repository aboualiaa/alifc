...
void COMPILE_MAC_64BIT() // string RAND, string PATH_FULL_ICO, string APP_PLIST)
{
  ...
  MAC_CMD = "clang++ -mmacosx-version-min=10.9 -m64 -O2 -std=c++11 -c -o "
            ...
            "-D_FILE_OFFSET_BITS=64 -DwxDEBUG_LEVEL=0 -I\"/Library/Application "
            "Support/Aliflang/Alif_Lib_WX/lib/wx/include/"
            "osx_cocoa-unicode-static-3.1-alif\" "
            "-I\"/Library/Application Support/Aliflang/Alif_Lib_WX/include\" "
            "-fno-common \"" +
            PATH_FULL_CPP +
            "\" "
            "2> \"" +
  ...
  MAC_CMD = "clang++ -m64 -mmacosx-version-min=10.9 -o \"" + PATH_FULL_BIN_TMP +
            "\" \"" + PATH_FULL_OBJ +
            "\" "
            "-L\"/Library/Application Support/Aliflang/Alif_Lib_WX/lib\" "
            "-framework IOKit "
            "-framework Carbon -framework Cocoa -framework AudioToolbox "
            "-framework System -framework OpenGL "
            "-lwx_osx_cocoau_alif_aui-3.1 -lwx_osx_cocoau_alif_propgrid-3.1 "
            "-lwx_osx_cocoau_alif_adv-3.1 "
            "-lwx_osx_cocoau_alif_stc-3.1  -lwx_osx_cocoau_alif_core-3.1  "
            "-lwx_baseu_alif-3.1  -lwxscintilla_alif-3.1 "
            "-lwxtiff_alif-3.1 -lwxjpeg_alif-3.1 -lwxpng_alif-3.1  -framework "
            "WebKit -lwxzlib_alif-3.1 -lwxregexu_alif-3.1 "
            "-lwxexpat_alif-3.1 -framework IOKit -framework Carbon -framework "
            "Cocoa -framework AudioToolbox -framework System "
            "-framework OpenGL -framework Security -lpthread -liconv  "
